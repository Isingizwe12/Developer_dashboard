...
function WeatherCard() {
  ...
  const API_KEY = "c745050c1708764fd9f71f0ca65de8b0"; // your OpenWeatherMap API key
    ...
    <div className="bg-white shadow-md rounded-xl p-6 w-full max-w-sm ">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{weather.weather[0].main}</p>
          <p className="text-gray-500 text-sm mt-1">Humidity: {weather.main.humidity}%</p>
          <p className="text-gray-500 text-sm mt-1">Wind: {windKmh} km/h</p>
          <p className="text-gray-500 text-sm mt-1">Time: {localTime}</p>
        </div>
